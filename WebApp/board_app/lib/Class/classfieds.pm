...
#  foreach my $subcategory (keys %{$classfieds{$category}{subcategory}}){
#    foreach my $advert_param (keys %{$classfieds{$category}{subcategory}{$subcategory}{advert_param}}){
#      my $advert_param_name=$classfieds{$category}->{subcategory}->{$subcategory}->{advert_param}->{$advert_param}->{name};
#      $classfieds{$category}->{subcategory}->{$subcategory}->{advert_param}->{$advert_param_name}=$classfieds{$category}->{subcategory}->{$subcategory}->{advert_param}->{$advert_param};
#      delete $classfieds{$category}->{subcategory}->{$subcategory}->{advert_param}->{$advert_param};
#      $classfieds{$category}->{subcategory}->{$subcategory}->{advert_param}->{$advert_param_name}->{name}=$advert_param;
#    }
#    my $subcategory_name=$classfieds{$category}->{subcategory}->{$subcategory}->{name};
#    $classfieds{$category}->{subcategory}->{$subcategory_name}=$classfieds{$category}->{subcategory}->{$subcategory};
#    delete $classfieds{$category}->{subcategory}->{$subcategory};
#    $classfieds{$category}->{subcategory}->{$subcategory_name}->{name}=$subcategory;
#  }
